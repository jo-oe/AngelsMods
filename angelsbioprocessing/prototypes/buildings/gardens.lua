  ...
  },
  {
    ...
    minable = {
      ...
      results = {
        ...
        { type = "item", name = "angels-temperate-1", amount = 5, shared_probability = { min = 0.00, max = 0.45 }},
        { type = "item", name = "angels-temperate-2", amount = 5, shared_probability = { min = 0.45, max = 0.80 }},
        { type = "item", name = "angels-temperate-3", amount = 5, shared_probability = { min = 0.80, max = 1.00 }},
      },
    },
  ...
  },
  {
    ...
    minable = {
      ...
      results = {
        ...
        { type = "item", name = "angels-desert-1", amount = 5, shared_probability = { min = 0.00, max = 0.45 }},
        { type = "item", name = "angels-desert-2", amount = 5, shared_probability = { min = 0.45, max = 0.80 }},
        { type = "item", name = "angels-desert-3", amount = 5, shared_probability = { min = 0.80, max = 1.00 }},
      },
    },
    emissions_per_second = { pollution = -0.006 }, --emissions_per_tick = -0.0001,
  ...
  },
  {
    ...
    minable = {
      ...
      results = {
        ...
        { type = "item", name = "angels-swamp-1", amount = 5, shared_probability = { min = 0.00, max = 0.45 }},
        { type = "item", name = "angels-swamp-2", amount = 5, shared_probability = { min = 0.45, max = 0.80 }},
        { type = "item", name = "angels-swamp-3", amount = 5, shared_probability = { min = 0.80, max = 1.00 }},
      },
    },
    emissions_per_second = { pollution = -0.006 }, --emissions_per_tick = -0.0001,
