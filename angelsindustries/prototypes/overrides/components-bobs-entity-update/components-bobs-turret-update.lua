  ...
  if mods["bobwarfare"] then
    ...
    OV.patch_recipes({
      ...
      },
      {
        ...
        ingredients = {
          { type = "item", name = "battery-3", amount = mods["bobplates"] and "bob-battery-2" or "battery" },
      ...
      },
      {
        ...
        ingredients = {
          { type = "item", name = "battery-4", amount = mods["bobplates"] and "bob-battery-2" or "battery" },
      ...
      },
      {
        ...
        ingredients = {
          { type = "item", name = "battery-5", amount = mods["bobplates"] and "bob-battery-3" or "battery" },
